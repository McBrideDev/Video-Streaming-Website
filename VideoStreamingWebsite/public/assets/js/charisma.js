$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'public/assets/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'public/assets/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('#file_upload').uploadify({
        'swf': 'public/assets/misc/uploadify.swf',
        'uploader': 'public/assets/misc/uploadify.php'
