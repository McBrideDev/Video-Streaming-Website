...
@section('title',"Add A New Language")
	...
	<div class="modal-dialog col-md-12" style="width:100% !important">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<?= Form::open(['url' => url('admincp/language/add'), 'method'=> 'POST', 'files' => true, 'class'=>'form-horizontal']) ?>
    			<div class="form-group {{$errors->has('languageName')? 'has-error':''}}">
    				<div class="col-md-2"><?=Form::label('Language Name')?></div>
    				<div class="col-md-10">
    					<?= Form::text('languageName', null, ['required', 'class'=>'form-control', 'placeholder'=>'Language name']) ?>
    			...
    			<div class="form-group {{$errors->has('languageCode')? 'has-error':''}}">
    				...
    				<div class="col-md-10">
    					<?= Form::text('languageCode', null, ['required', 'class'=>'form-control', 'placeholder'=>'Language code']) ?>
    					<span class="required help-block">{{$errors->first('languageCode')}}</span>	
    				</div>
    			</div>
    			<div class="form-group">
    				<div class="col-md-2"><?=Form::label('Status')?></div>
    				<div class="col-md-10"><?= Form::select('status',['active' => 'Active', 'inactive' => 'Inactive'],NULL ,array('class' => 'form-control')) ?></div>
    			</div>
