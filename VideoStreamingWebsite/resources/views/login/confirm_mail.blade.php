<div id=":32y" class="ii gt m15124d0c96835615 adP adO">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p>Please follow this link to verify your account: <a href="{{URL(getLang().'register.html&action=active&token=')}}{{$token}}" style="color:#08c;text-decoration:none" target="_blank">{{URL('register.html&action=active&token=')}}{{$token}}</a>
                            </p>
