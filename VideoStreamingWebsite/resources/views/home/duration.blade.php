...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="titile-cate">
            ...
            <ul>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">{{trans('home.DURATIONS')}}<span class="caret"></span></a>
                    <ul class="dropdown-menu" id="video-filter">
                        ...
                        <li class="active"><a href="javascript:void(0)" data-value="duration">{{trans('home.DURATIONS')}}</a></li>
        ...
        <div class="row content-image videos">
            <?php $items = 1; ?>
            @foreach($duration as $result)
            <?php $rating = VideoHelper::getRating($result->string_Id); ?>
            <div class="col-xs-12 col-sm-3 col-md-2 image-left">
                <div class="col">
                    <div class="col_img">
            ...
            <?php if ($items == 3) { ?>
              <div class="col-xs-12 col-sm-4 col-md-4 image-right pull-right hidden-xs hidden-sm">
